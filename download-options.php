...
if ( ! empty( $_POST['Submit'] ) ) {
	...
	$download_path                 = ! empty( $_POST['download_path'] ) ? sanitize_text_field( wp_unslash( $_POST['download_path'] ) ) : '';
	$download_path_url             = ! empty( $_POST['download_path_url'] ) ? sanitize_text_field( wp_unslash( $_POST['download_path_url'] ) ) : '';
	$download_page_url             = ! empty( $_POST['download_page_url'] ) ? sanitize_text_field( wp_unslash( $_POST['download_page_url'] ) ) : '';
	...
	$download_options_rss_sortby   = ! empty( $_POST['download_options_rss_sortby'] ) ? sanitize_text_field( wp_unslash( $_POST['download_options_rss_sortby'] ) ) : '';
	...
	$download_categories_post      = ! empty( $_POST['download_categories'] ) ? explode( "\n", sanitize_textarea_field( wp_unslash( $_POST['download_categories'] ) ) ) : '';
	$download_sort_by              = ! empty( $_POST['download_sort_by'] ) ? sanitize_text_field( wp_unslash( $_POST['download_sort_by'] ) ) : '';
	$download_sort_order           = ! empty( $_POST['download_sort_order'] ) ? sanitize_text_field( wp_unslash( $_POST['download_sort_order'] ) ) : '';
	...
	$download_sort                 = array(
		'by'      => $download_sort_by,
		'order'   => $download_sort_order,
		'perpage' => $download_sort_perpage,
		'group'   => $download_sort_group,
	);
	...
	$download_options = array(
		...
		'rss_sortby'   => $download_options_rss_sortby,
		'rss_limit'    => $download_options_rss_limit,
	);
