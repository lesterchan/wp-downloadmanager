...
class Test_Security extends DownloadManager_TestCase {
	...
	public function test_listing_sort_column_is_allow_listed() {
		...
		$sort['by']    = 'file_name, (SELECT 1)';
		$sort['order'] = 'asc; SELECT 1';
	...
	public function test_feed_sort_column_is_allow_listed() {
		$options               = get_option( 'download_options' );
		$options['rss_sortby'] = 'file_date, (SELECT 1)';
		$options['rss_limit']  = '5 UNION SELECT 1';
		update_option( 'download_options', $options );
	...
	public function test_activation_does_not_call_wp_get_sites() {
		$this->assertStringNotContainsString( 'wp_get_sites', $this->code( 'wp-downloadmanager.php' ) );
	}
	...
	public function test_activation_uses_current_upgrade_include() {
		$this->assertStringNotContainsString( 'upgrade-functions.php', $this->code( 'wp-downloadmanager.php' ) );
	}
	...
	public function test_activation_does_not_pass_deprecated_add_option_arg() {
		$source = $this->code( 'wp-downloadmanager.php' );
