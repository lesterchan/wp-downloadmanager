...
if( ! empty( $_POST['Submit'] ) ) {
    ...
    $download_template_header = ! empty ( $_POST['download_template_header'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_header'] ) ) ) : '';
    $download_template_footer = ! empty ( $_POST['download_template_footer'] ) ? wp_kses( trim( wp_unslash( $_POST['download_template_footer'] ) ), $allowed_tags )  : '';
    $download_template_pagingheader = ! empty ( $_POST['download_template_pagingheader'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_pagingheader'] ) ) )  : '';
    $download_template_pagingfooter = ! empty ( $_POST['download_template_pagingfooter'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_pagingfooter'] ) ) )  : '';
    $download_template_none = ! empty ( $_POST['download_template_none'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_none'] ) ) )  : '';
    $download_template_category_header = ! empty ( $_POST['download_template_category_header'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_category_header'] ) ) )  : '';
    $download_template_category_footer = ! empty ( $_POST['download_template_category_footer'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_category_footer'] ) ) )  : '';
    $download_template_listing[] = ! empty ( $_POST['download_template_listing'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_listing'] ) ) )  : '';
    $download_template_listing[] = ! empty ( $_POST['download_template_listing_2'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_listing_2'] ) ) )  : '';
    $download_template_embedded[] = ! empty ( $_POST['download_template_embedded'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_embedded'] ) ) )  : '';
    $download_template_embedded[] = ! empty ( $_POST['download_template_embedded_2'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_embedded_2'] ) ) ) : '';
    $download_template_download_page_link = ! empty ( $_POST['download_template_download_page_link'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_download_page_link'] ) )  ) : '';
    $download_template_most[] = ! empty ( $_POST['download_template_most'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_most'] ) ) ) : '';
    $download_template_most[] = ! empty ( $_POST['download_template_most_2'] ) ? wp_kses_post( trim( wp_unslash( $_POST['download_template_most_2'] ) ) ) : '';
